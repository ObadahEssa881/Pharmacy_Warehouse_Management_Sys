...
var FirebaseAdminService = /** @class */ (function () {
    ...
    FirebaseAdminService_1 = FirebaseAdminService;
    FirebaseAdminService.prototype.sendNotification = function (token, title, body, data) {
        if (data === void 0) { data = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, admin.messaging().send({
                        token: token,
    ...
    FirebaseAdminService = FirebaseAdminService_1 = __decorate([
        common_1.Injectable()
