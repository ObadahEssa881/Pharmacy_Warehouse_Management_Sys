...
var SupplierService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        supplier = _a.sent();
                        if (!supplier) {
                            return [2 /*return*/, 'there is no users to show'];
                        }
    ...
    SupplierService.prototype.findOne = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var supplier;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    SupplierService.prototype.remove = function (email) {
        return __awaiter(this, void 0, void 0, function () {
            var supplier;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.prisma.supplier["delete"]({
                            where: {
                                email: email
                            }
                        })];
