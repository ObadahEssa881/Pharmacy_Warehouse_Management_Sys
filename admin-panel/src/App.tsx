...
import { MedicinesList } from './resources/medicines/MedicinesList';
import { PurchaseOrdersList } from './resources/purchase-orders/PurchaseOrdersList';
import ProfitLossReport from './resources/reports/ProfitLossReport';
    ...
    <Admin dashboard={Dashboard} authProvider={authProvider} dataProvider={dataProvider}>
      ...
      {role === 'PHARMACY_OWNER' && (
        <>
          ...
          <Resource name="reports/profit-loss" list={ProfitLossReport} />
        </>
      )}
    </Admin>
  );
